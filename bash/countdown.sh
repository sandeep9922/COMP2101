...
trap intResert SIGINT

############################
#####
###function for reseting int
function intResert {
  ...
  echo "they are not allowed to interept"
}
##################adding trap quit###############

trap quitSignal SIGQUIT
#####################
#### function quitting
function quitSignal {
  echo "you found a secret to exit this script"
  stty sane
  clear
  exit
}
...
#### Variables
programName="$0" # used by errr_functions.sh
